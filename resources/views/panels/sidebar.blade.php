        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <h2 class="brand-text">VacuoleX</h2>
                </a>
            </li>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (isset($menuData[0]))
                @foreach ($menuData[0]->menu as $menu)
                    @if (isset($menu->adminonly) && !empty($menu->adminonly) && auth()->user()->role->level != 1)
                        @continue
                    @endif
                ...
                <li
                    class="nav-item">
                    <a class="d-flex align-items-center" href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logout-form-sidebar').submit();">
