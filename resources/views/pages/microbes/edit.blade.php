...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('microbes.update', $microbe) }}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <div class="position-relative" id="microbe-image-container">
                        <img class="rounded microbe-image border" id="microbe-image"
                            src="{{ $microbe->image }}" alt="Microbe Image">
                ...
                <div class="row mt-2">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                                id="title" value="{{ empty(old("title")) ? $microbe->title : old("title") }}" />
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control form-control-lg" id="sub-category-id"
                                ...
                                @foreach ($subcategories as $subcategory)
                                    ...
                                    @else
                                        @if ($microbe->sub_category_id == $subcategory->id)
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="excerpt" id="excerpt" rows="2">{{ empty(old("excerpt")) ? $microbe->excerpt : old("excerpt") }}</textarea>
                            @error('excerpt')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" rows="30">{{ empty(old("description")) ? $microbe->description : old("description") }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
