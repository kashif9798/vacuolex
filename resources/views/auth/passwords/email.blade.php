...
<div class="auth-wrapper auth-v2">
  <div class="auth-inner row m-0">
    ...
    <a class="brand-logo" href="javascript:void(0);">
      ...
      <h2 class="brand-text text-primary ml-1">VacuoleX</h2>
    </a>
    <!-- /Brand logo-->
    <!-- Left Text-->
      ...
      <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
        ...
        <form class="auth-forgot-password-form mt-2" method="POST" action="{{ route('password.email') }}">
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('email') is-invalid @enderror"" id="forgot-password-email" type="text" name="email" value="{{ old('email') }}" placeholder="john@example.com" aria-describedby="forgot-password-email" autofocus="" tabindex="1" />
            @error('email')
        ...
        <p class="text-center mt-2">
          @if (Route::has('login.form'))
            <a href="{{ route('login.form') }}"> <i data-feather="chevron-left"></i> Back to login </a>
          @endif
        </p>
      </div>
    </div>
