                    ...
                    <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-merge form-password-toggle @error('password') is-invalid @enderror">
                                <input class="form-control form-control-merge @error('password') is-invalid @enderror" id="reset-password-new" type="password"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input class="form-control form-control-merge" id="reset-password-confirm" type="password"
                                    ...
                                    aria-describedby="reset-password-confirm" tabindex="2" autocomplete="new-password" />
                                <div class="input-group-append">
